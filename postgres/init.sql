...
insert into project(name, client_id, start_date, end_date)
values ('창원 SMVS 6CH', 2, '2025.02.11','2025.09.20'),
       ('오물란 검사기', 1, '2025.02.11','2025.09.20');
insert into task(name, step, start_date, end_date, project_id)
values ('카메라 셋업 및 학습 영상 확보', '완료', '2025.02.11','2025.09.20', 1),
       ('카메라 셋업 및 학습 영상 확보', '이슈 대응 중', '2025.02.11','2025.09.20', 1);
